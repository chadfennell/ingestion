...
MODULES = [
    ...
    "dplaingestion.akamod.enrich_subject",
    "dplaingestion.akamod.enrich_type",
    "dplaingestion.akamod.enrich_format",
    "dplaingestion.akamod.enrich_date",
    "dplaingestion.akamod.select_id",
    "dplaingestion.akamod.shred",
    "dplaingestion.akamod.geocode",
    "dplaingestion.akamod.oai_to_dpla",
    "dplaingestion.akamod.oai_set_name",
    "dplaingestion.akamod.dpla_list_records",
    ...
    "dplaingestion.akamod.dpla_get_record",
    ...
    "dplaingestion.akamod.primo_to_dpla",
    ...
    "dplaingestion.akamod.arc_to_dpla",
